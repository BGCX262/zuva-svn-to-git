...
public class Blackjack {
    ...
    public static class Deck {
        ...
        public Deck(List<Card> cards) {
        	this.cards = new LinkedList<Blackjack.Card>();
        	for(Card card: cards) {
        		this.cards.add(card);
        	}
        }
        ...
        public void shuffle(Random random) {
            ...
            while(originalCards.size() > 0) {
                int nextCardIndex = random.nextInt(originalCards.size());
                Card nextCard = originalCards.remove(nextCardIndex);
    ...
    public static class Hand {
        ...
        public boolean beats(Hand other) {
            ...
            if (otherScore <= 21 && otherScore >= myScore) {
                return false;
            }
            return true;
        }
    ...
    public static class ProbabilityCalculator {
        ...
        public double calculateProbability(int currentPoints) {
            ...
            return ((double) numberOfBusts / (double) this.fullDeck.size());
        }
    }
    ...
    public static class Game {
        ...
        /**
         * Main_UVA10054 control loop. You an imagine this routine to reflect the actions of the dealer, who
    ...
    /**
     * Main_UVA10054 method. Constructs the object, plays the game, prints the output.
